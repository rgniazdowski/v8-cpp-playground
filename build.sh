...
cmake -DCMAKE_BUILD_PARALLEL_LEVEL=32 -DCMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE -DCMAKE_TOOLCHAIN_FILE="${TOOLCHAIN_PATH}" -B"${TARGET_BUILD_DIR}" -S"${REAL_CWD}" -T host=x64 -A x64
